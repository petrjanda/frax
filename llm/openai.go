...
func (a *OpenAIAdapter) Invoke(ctx context.Context, request *LLMRequest) (*LLMResponse, error) {
	...
	if len(resp.Choices) > 0 {
		...
		if choice.Message.Content != "" {
			...
			textMsg := &UserMessage{Content: choice.Message.Content}
...
func (a *OpenAIAdapter) convertMessages(messages []Message) []openai.ChatCompletionMessageParamUnion {
...
func (a *OpenAIAdapter) convertTools(tools []Tool) []openai.ChatCompletionToolUnionParam {
